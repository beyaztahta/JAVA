...
public enum UsStates {
    ...
    public static String getStateNameFromAbbreviation(String abbreviation){
       ...
       return Arrays.//Enumlarda lambda kullanmak ıstıyorsanız Arrays classına gıtmeniz lazım.Arrays.stream(values()) kullanılır.
               stream(values()).
               filter(UsStates-> UsStates.getAbbreviation().equals(abbreviation)).
               findFirst().
               get().
               getStateName();
    ...
    public static String getStateNameFromCapıtal(String capital){
      return  Arrays.
              stream(values()).
    ...
    //Example 1: Baskenti verilen state ın kısaltmasını ekrana yzdıran methodu olusturunuz.
