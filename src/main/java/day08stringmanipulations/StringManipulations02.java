...
public class StringManipulations02 {
    public static void main(String[] args) {
        ...
        int number=cumle.replace(" ","").length();
        ...
        String s="Ankara'nın tasına,gozlerimin yasına bak.";
        ...
        //           "AC202117004" ==> AC*********
        String n="AC061000059";
        String yeniN=n.replace("[0-9]","*");
        System.out.println(yeniN);
         /*
        ...
        //           ii)En az 1 sembol icermeli
           boolean second=pwd.replace("[0-9a-zA-Z]","").length()>0;

        //           iii)En az 1 rakam icermeli
           boolean third=pwd.replace("[^0-9]","").length()>0;

        //           iv)En az 1 buyuk harf icermeli
        boolean fourth=pwd.replace("[^A-Z]","").length()>0;

        //           v)En az 1 kucuk harf icermeli
           boolean fifth=pwd.replace("[^a-z]","").length()>0;

           boolean pwdGecerli=first&&second&&third&&fourth&&fifth;
           if(pwdGecerli){
               System.out.println("Passwordunuz gecerlidr.");
           }else{
        ...
        //Example 7: Bir String'deki noktalama isaretlerinin sayisini gosteren kodu yaziniz
           String c="Sen yapmazsan,ben yapmasam,o yapmazsa kim yapacak?...";
           int v=c.replace("^\\p{Punct}","").length();
         ...
         String x="Alex";
         boolean ilk=x.startsWith("Al");
         boolean son=x.endsWith("x");
         String result= ilk && son ? "Harika":"Normal";
