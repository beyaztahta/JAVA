    ...
    public void login(){
        ...
        do {
           ...
           try{
               ...
               System.out.println("Pın numaranızı gırınız.");
               setPinNumber(input.nextInt());

           }catch(Exception e){
               System.out.println("Yanlıs karakter girdiniz.Lutfen sadece rakam giriniz veya Q ya basıp cıkınız.");
    ...
    public void getAccountTypes(){
        ...
        switch (option){
            ...
            case 2:
                ...
                break;
            case 3:
                System.out.println("ATM makınemızı kullandıgınız ıcın tesekkur ederız.");
                flag=false;
                break;
            default:
                System.out.println("Yanlıs secenek! 1,2, veya 3 u kullanınız.");
        }
